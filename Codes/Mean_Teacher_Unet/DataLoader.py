...
if __name__ == '__main__':
    i_path = 'Txt/Txt_acnet_cbe_1/image.txt'
    l_path = 'Txt/Txt_acnet_cbe_1/label.txt'
    m_path = 'Txt/Txt_acnet_cbe_1/mask.txt'
    ...
    shape  = (224, 288, 288)
    train_dataset = DataLoad(i_path, l_path, m_path, shape)
